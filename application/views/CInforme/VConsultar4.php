<!-- This is the view where the JSON RIPS report is generated -->
...
<div class="informe-container">
    <div class="informe-header">
        <h3>📋 Generar RIPS (JSON)</h3>
        <p>Genere archivo JSON RIPS para regulación seleccionando el rango de fechas</p>
    </div>

    <form id="formInforme" action="<?= site_url('CInforme/exportar_json') ?>" method="post">
...
<div id="downloadOverlay" class="download-overlay">
    <div class="download-modal" id="downloadModal">
        ...
        <div class="download-status">Procesando datos RIPS</div>
    </div>
</div>
...
document.getElementById('formInforme').addEventListener('submit', function(e) {
    ...
    setTimeout(function() {
        ...
        modal.querySelector('.download-status').textContent = 'Archivo RIPS generado correctamente';
        ...
        setTimeout(function() {
            ...
            modal.querySelector('.download-status').textContent = 'Procesando datos RIPS';
